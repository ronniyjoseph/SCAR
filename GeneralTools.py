...
def solution_histogram_plotter(amp_solutions, phase_solutions,noisy_amp_info_l,noisy_phase_info_l,output_folder):
	...
	for i in range(len(l)):
		...
		#plot the amplitude data
			...
			#Plot solutions histograms
			ampsub.hist(amp_solutions[j,i,:],histtype = 'stepfilled',edgecolor='none',alpha=0.7,bins=500,facecolor='blue')
			phasesub.hist(phase_solutions[j,i,:],histtype = 'stepfilled',edgecolor='none',alpha=0.7,bins=500,facecolor='blue')
