...
def source_flux_and_position_offset_changer(telescope_param,calibration_channel,noise_param, sky_param, beam_param,
                                              calibration_scheme, peakflux_range, offset_range,n_iterations,save_to_disk,
                                            processes):
    """
    """
    ...
    pool.map(single_iteration_source_flux_position_offset(args, numpy.arange(n_iterations)))
...
def single_iteration_source_flux_position_offset():
